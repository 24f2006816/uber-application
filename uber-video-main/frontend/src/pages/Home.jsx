...
const Home = () => {
    ...
    async function findTrip() {
        if (!pickup || !destination || pickup.trim().length < 3 || destination.trim().length < 3) {
            alert('Please enter pickup and destination locations (at least 3 characters each).')
            return
        }
        ...
        try {
            ...
            alert(err.response?.data?.message || 'Could not fetch fare estimate. Please try again.')
        }
    }
