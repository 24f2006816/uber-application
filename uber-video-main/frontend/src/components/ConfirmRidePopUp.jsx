...
const ConfirmRidePopUp = (props) => {
    ...
    const submitHander = async (e) => {
        ...
        try {
            const response = await axios.get(`${import.meta.env.VITE_BASE_URL || 'http://localhost:3000'}/rides/start-ride`, {
                params: {
            ...
            setError(err.response?.data?.message || 'Invalid OTP or failed to start ride')
        } finally {
